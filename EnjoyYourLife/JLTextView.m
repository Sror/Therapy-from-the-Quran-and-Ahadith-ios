...
@synthesize attributes = _attributes, syntaxTokenizer = _syntaxTokenizer, lineHeight = _lineHeight,charWidth = _charWidth;
...
- (BOOL)textView:(UITextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text
{
    ...
    [self.attributedString addAttribute:(id)kCTForegroundColorAttributeName value:(id)[UIColor redColor].CGColor range:options.range];
...
//         CTParagraphStyleRef style = CTParagraphStyleCreate(_settings,sizeof(_settings)/sizeof(_settings[0]));
